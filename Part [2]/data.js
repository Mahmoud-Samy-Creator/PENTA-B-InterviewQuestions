...
/**
 * An array of coordinates representing obstacles.
 * Each coordinate is represented as an array with two numbers: [x, y].
 * 
 * @constant {number[][]} ObstcalsCoordinates
 * @default [[1, 4], [3, 5], [7, 4]]
 */
export const ObstcalsCoordinates = [[1,4], [3,5], [7,4]]